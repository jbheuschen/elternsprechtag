...
class TeacherController extends AbstractController
{
     ...
     */
    public function new(Request $request, UserPasswordEncoderInterface $upei): Response
    {
        $teacher = new Teacher();
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            $teacher->setPassword($upei->encodePassword($teacher, $form->get('password')->getData()));
